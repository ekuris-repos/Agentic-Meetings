...
- **Meeting Protocol**: Centralized in `meetings/meeting-protocol.agent.md` for all agents to follow
...
- Agent personas should be minimal - they reference `meeting-protocol.agent.md` for protocol details
- All meeting protocol logic lives in `meetings/meeting-protocol.agent.md`, not in PowerShell scripts
